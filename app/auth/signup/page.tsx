import SignupwithForm from '@/components/Auth/SignupForm/page'; // your password form
import Image from 'next/image';
import Link from 'next/link';
import type { Metadata } from 'next';
import FacebookSignupButton from '@/components/Auth/FacebookSignupButton';
import GoogleSignupButton from '@/components/Auth/GoogleSignupButton';
import Signup from '@/components/Auth/SignupForm/page';
...
export default function SignUpPage() {
  return (
    <div className='relative overflow-hidden rounded-[10px] bg-white  dark:bg-gray-dark dark:shadow-card'>
      <div className='flex flex-col lg:flex-row'>
        ...
        <div className='w-full  lg:w-1/2 bg-primary text-white flex flex-col justify-between px-10 py-10'>
          <div>
            ...
            <p className='mt-3 text-sm text-blue-100 max-w-md'>
              Create your free account to start tracking productivity, managing
              shifts, and collaborating with your team.
            </p>
          </div>
        ...
        <div className='w-full lg:w-1/2 px-8 py-10 sm:px-12'>
          ...
          <div className=' grid grid-cols-1 gap-4 sm:grid-cols-2'>
            ...
            <FacebookSignupButton text='Facebook' />
          </div>

          {/* divider */}
          <div className='my-6 flex items-center justify-center'>
            <span className='block h-px w-full bg-stroke dark:bg-dark-3' />
            <div className='block w-full max-w-fit bg-white px-3 text-xs text-center font-medium text-slate-400 dark:bg-gray-dark'>
              Or
            </div>
            <span className='block h-px w-full bg-stroke dark:bg-dark-3' />
          </div>
